...
<head>
  ...
  <link rel="stylesheet" href="js/jquery-ui/jquery-ui-1.13.2/jquery-ui.css">
...
<body>
  ...
  <div class="container">
    <div class="row">
      <br/>
      <h2 align="center">Search Vendors</h2>
      <br />
      <div class="col-md-3">
        <div class="list-group">
          <h3>Kategori</h3>
          <?php
          $query = "SELECT DISTINCT(jenis_produk) FROM fyp_vendors ORDER BY jenis_produk DESC";
          ...
          foreach ($result as $row) {
            ...
            <div class="list-group-item checkbox">
              <label><input type="checkbox" class="common_selector jenis_produk" value="<?php echo $row['jenis_produk']; ?>"> <?php echo $row['jenis_produk']; ?></label>
            </div>
            <?php
          }
          ?>
